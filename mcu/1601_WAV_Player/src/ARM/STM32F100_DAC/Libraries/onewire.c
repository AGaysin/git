...
void OW_TermMain (void)
{
    ...
    else if (TermReadEnable==2) //Ожидание данных
    {
      if (DMA_GetFlagStatus(OW_DMA_FLAG) == RESET) TermReadEnable=3;
    }
    else if (TermReadEnable==3) //Ожидание данных
    {
    ...
    else if (TermReadEnable==4) //Ожидание данных
    {
      if (DMA_GetFlagStatus(OW_DMA_FLAG) == RESET) TermReadEnable=5;
    }
    else if (TermReadEnable==5) //Ожидание данных
    {
      // отключаем DMA
      DMA_Cmd(OW_DMA_CH_TX, DISABLE);
      DMA_Cmd(OW_DMA_CH_RX, DISABLE);
    ...
    else if (TermReadEnable==9) //Ожидание данных
    {
    ...
    else if (TermReadEnable==11) //Ожидание данных
    {
    ...
    else if (TermReadEnable==13) //Ожидание данных
    {
    ...
    else if (TermReadEnable==15) //Ожидание данных
    {
      if (DMA_GetFlagStatus(OW_DMA_FLAG) == RESET) TermReadEnable=16;
    }    
    else if (TermReadEnable==16) //Ожидание данных
    {
      // отключаем DMA
      DMA_Cmd(OW_DMA_CH_TX, DISABLE);
      DMA_Cmd(OW_DMA_CH_RX, DISABLE);
